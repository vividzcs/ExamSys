...
<body  ng-app="exam"  ng-controller="createTestPaper" >
	<div style="height: 100%;" class=" row border-bottom white-bg dashboard-header" >
		<div class="col-lg-7" > 
		<form action="${pageContext.request.contextPath }/student/beginPratice.action" method="post">
			<div class="form-group"> 
                                        <label class="col-sm-3 control-label">专业</label>
                                        <div class="col-sm-8">
                                            <select id="profess" name="m_id" class="form-control m-b"   ng-model="selected" ng-options="m.profess for m in professes" ng-change="changeClassification(selected)">
                                                 <option value="">-- 请选择 --</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">练习科目</label>
                                        <div class="col-sm-8">
                                             <select id="subject" name="sub_id" class="form-control m-b"   ng-model="selected2" ng-options="m for m in course" >
                                             	  <option value="">-- 请选择 --</option>
                                            </select>
                                        </div>
                                    </div>
		    <div class="form-group">
			      <div class="col-sm-9 col-sm-offset-10">
				   <button class="btn btn-primary" ng-click="toggle()" type="">开始练习</button>
			      </div>
           </div>
           </form>
          </div>
