				       ...
				       <div class="col-lg-10" >
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form class="form-horizontal m-t" id="addProfessForm" action="${pageContext.request.contextPath }/admin/profess_update.action" method="post">
                                   <div class="form-group"  >
                                        <label class="col-sm-3 control-label">院系</label>
                                        <input type="hidden" name="m_id" value="${major.m_id }">
                                        <div class="col-sm-8">
                                            <select class="form-control m-b"  ng-model="selected" ng-options="m.department for m in departments" name="academy.a_id" >
                                                 ...
                                                 <option value="${academy.a_id }" <c:if test="${major.academy.a_id eq academy.a_id }">selected="selected"</c:if> >${academy.a_name }</option>
                                                 </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="professnumber" name="m_number" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error sname" value="${major.m_number }">
                                        </div>
                                    </div>
                                      <div class="form-group">
                                        <label class="col-sm-3 control-label">专业名称</label>
                                        <div class="col-sm-8">
                                            <input id="professname" name="m_name" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error sname" value="${major.m_name }">
                                        </div>
                                    </div>
                                    <div class="form-group">
