                                    ...
                                    <tbody>
                                      <c:forEach items="${list }" var="academy">
                                        <tr class="gradeX">
                                            ...
                                            <td class="center"><a href="${pageContext.request.contextPath }/admin/academy_edit.action?a_id=${academy.a_id }">修改</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/admin/academy_delete.action?a_id=${academy.a_id }" class="deletedepartment">删除</a></td>
                                        </tr>
                                       </c:forEach>
                                    </tbody>
                                    <tfoot>
