				       ...
				       <div class="col-lg-10" >
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form class="form-horizontal m-t" id="addDepartmentForm" action="${pageContext.request.contextPath }/admin/department_update.action" method="post">
                                	 <div class="form-group">
                                        <label class="col-sm-3 control-label">院系编号</label>
                                        <input type="hidden" name="a_id" value="${academy.a_id }">
                                        <div class="col-sm-8">
                                            <input id="departmentnumber" name="a_number" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error sname" value="${academy.a_number }">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">院系名称</label>
                                        <div class="col-sm-8">
                                            <input id="departmentname" name="a_name" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error sname" value="${academy.a_name }">
                                        </div>
                                    </div>
                                    <div class="form-group">
